...
const OrderSummary = () => {
	...
	return (
		...
		<div className="rounded-lg bg-gradient-to-r from-[#606cfc] to-[#ff64c4] p-px">
			...
			>
				{/* ALTERADO: Título e cores internas com o gradiente roxo/rosa */}
				...
				<div className='space-y-4'>
					...
					<div className='flex items-center justify-center gap-2'>
						...
						<Link
							to='/'
							// ALTERADO: Classes de layout e de 'group' para o efeito de hover
							className='inline-flex items-center gap-2 text-sm font-medium group'
						>
							{/* O <span> aplica o gradiente apenas ao texto */}
							...
							{/* O ícone recebe uma cor sólida do gradiente e um efeito de hover */}
							<MoveRight
								size={16}
